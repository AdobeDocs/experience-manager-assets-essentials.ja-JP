...
* 既存のアセットと同じファイル名で、既存のアセットと同じフォルダーに新しいアセットをアップロードします。[!DNL Assets Essentials] では、前のアセットを上書きするか、新しいアセットをバージョンとして保存するかを確認するプロンプトを表示します。 [重複したアセットのアップロード](/help/using/add-delete.md#resolve-upload-fails)を参照してください。
...
* [ビデオを視聴して Assets Essentials でのアセットの管理を学ぶ](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/assets-essentials/basics/managing)

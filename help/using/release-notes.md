...
* 以前の既知の問題を含む、様々なバグ修正と製品の機能強化（アップロード後の左側のナビゲーションツリーにフォルダーが正しく表示されるようになりました<!-- CQ-4337638 -->、ドラッグ&amp;ドロップのアップロードでは、アップロード用にドロップする際に現在のフォルダーまたはサブフォルダーのいずれかを選択できるようになりました）。

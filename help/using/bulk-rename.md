---
title: ' [!DNL Assets Essentials] での名前変更とアセット名の一括変更'
description: 新しいAssets UI （Assets Essentials）を使用してアセットの名前を一括変更する方法について説明します。 複数のアセット名を一度に変更できます。
role: User
...
* ファイルに001、002などのプレフィックスを付けて、英語に翻訳します。

...
3. 「**[!UICONTROL 適用]**」をクリックします。
   ![Adobe Expressで画像を保存](/help/using/assets/adobe-express-crop-image.png)
...
Essentials UIでの![express](/help/using/assets/express-in-essentials-ui.jpg)
Adobe Expressの埋め込みエディター内で画像を編集するには、次の手順に従います。
...
>[!MORELIKETHIS]
>
>* [アセットのバージョン履歴を表示](/help/using/navigate-view.md)

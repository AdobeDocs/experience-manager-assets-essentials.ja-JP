...
1. 組織の[Admin Console](https://adminconsole.adobe.com)にアクセスし、上部バーの&#x200B;**[!UICONTROL 製品]**&#x200B;をクリックし、**[!UICONTROL AEM Assets Essentials]**&#x200B;をクリックしてから[!DNL Assets Essentials]環境をクリックします。[!DNL Assets Essentials] には、管理者、通常ユーザー、消費者ユーザーのアクセスを表す3つの製品プロファイルがあります。

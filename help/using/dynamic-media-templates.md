...
1. Assets Essentials に移動し、左側のパネルにある「**[!UICONTROL Dynamic Media アセット]**」をクリックします。
...
1. キャンバスページで、「**[!UICONTROL プレビュー]**」をクリックします。 また、**[!UICONTROL Assets Essentials]**&#x200B;**／**&#x200B;**[!UICONTROL Dynamic Media アセット]**&#x200B;**に移動して、**&#x200B;テンプレートを見つけて選択&#x200B;**し、**「**[!UICONTROL テンプレートを編集]**&#x200B;**」をクリックして、**「**[!UICONTROL プレビュー]**」をクリックすることもできます。 プレビューページには、テンプレート、そのパラメーター（パラメーター化されたレイヤとプロパティ）、公開ステータスおよび「**[!UICONTROL 公開]**」オプションが表示されます。
...
1. Assets Essentials で、「**[!UICONTROL Dynamic Media アセット]**」をクリックします。
2. テンプレートの場所に移動します。
3. テンプレートを選択します。

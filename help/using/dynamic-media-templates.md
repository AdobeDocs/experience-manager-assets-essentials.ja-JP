...
**[!UICONTROL Dynamic Media Assets]**&#x200B;の下にフォルダー[&#128279;](/help/using/add-delete.md)を作成するには、**[!UICONTROL Assets]**&#x200B;の下にフォルダーを作成します。 **[!UICONTROL アセット]**&#x200B;の下のフォルダーツリーは、**[!UICONTROL Dynamic Media アセット]**&#x200B;の下にレプリケートされます。

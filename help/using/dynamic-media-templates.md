...
**[!UICONTROL Dynamic Media Assets]**&#x200B;の下にフォルダー](/help/using/add-delete.md)を[作成するには、**[!UICONTROL Assets]**&#x200B;の下にフォルダーを作成します。 **[!UICONTROL アセット]**&#x200B;の下のフォルダーツリーは、**[!UICONTROL Dynamic Media アセット]**&#x200B;の下にレプリケートされます。
...
![ テンプレートをクリックしてチラシを迅速に作成します](/help/using/assets/show-layers-list.svg) **>**&#x200B;その他のオプション （![](/help/using/assets/three-dots.svg)）をキャンバスレイヤーに追加して、テンプレートの作成中にいつでもキャンバスディメンションを編集できます。
...
1. 「**[!UICONTROL 保存]**」をクリックします。
   ![即時のコンテンツ作成](/help/using/assets/parameterise-a-layer.png)
...
1. **オプション：****[!UICONTROL 非表示]**&#x200B;パラメーターの値を 0 と 1 の間で変更し、「**[!UICONTROL 更新]**」をクリックして変更を確認します。 同じ非表示パラメーターを持つレイヤーは、まとめて非表示または表示されます。 同様に、URL からレイヤーの表示をコントロールできます。
   ...
   ![その場でコンテンツを作成](/help/using/assets/dm-templates-publish-status.png)

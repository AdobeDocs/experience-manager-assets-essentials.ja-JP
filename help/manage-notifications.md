...
Assets Essentials通知を使用すると、リポジトリーで使用可能なアセット、フォルダーまたはコレクションに対して実行された操作を監視できます。 通知を送信するコンテンツを選択し、購読する必要があります。また、通知を受け取るカテゴリを設定することもできます。
...
<table>
    <tbody>
     ...
     <tr>
      ...
      <td>ユーザーが購読済みのアセット、フォルダーまたはコレクションを削除すると、通知を受け取ります。</td>
     </tr>
     <tr>
      <td>購読しているコンテンツの外部共有</td>
      <td>購読済みのアセット、フォルダーまたはコレクションの公開リンクをユーザーが生成すると、通知を受け取ります。</td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td>ユーザーが購読済みフォルダーまたはコレクションにアセットを追加または削除すると、通知を受け取ります。</td>
     </tr>    
    </tbody>
   </table>
...
## フォルダー、アセット、コレクションの監視と監視解除 {#watch-unwatch-assets}
...
コンテンツを購読するには、購読する必要があるフォルダー、アセットまたはコレクションを選択して、「 」をクリックします **[!UICONTROL 所要時間]**.
...
Assets Essentials は購読しているカテゴリの通知を送信するようになりました。複数のアセット、フォルダーまたはコレクションを選択して、 **[!UICONTROL 所要時間]** 時間を節約できます。 ただし、一部が既に購読されている複数のエンティティを選択した場合、「**[!UICONTROL ウォッチ]**」オプションは表示されません。

同様に、購読解除するには、購読したアセット、フォルダーまたはコレクションを選択し、「 」をクリックします **[!UICONTROL 監視解除]**.
